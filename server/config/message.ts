module.exports = {
    ...
    message_error_course: "Não foi possível buscar pelos cursos",
    message_department_question: "Qual setor você deseja?",
    message_error_department: "Não foi possível buscar pelo setor",
    message_not_more_information: "Ops, neste setor não tem mais informações :/",
    message_error_more_information: "Não foi possível buscar mais informações",
    message_phone_question: "Quais telefones você deseja?",
    message_error_phone: "Não foi possível buscar pelo telefone",
    message_news: "Aqui estão as últimas notícias postadas no site! ;)",
    message_error_news: "Não foi possível buscar pelas notícias",
    message_initial_question: "Deseja algo mais?",
